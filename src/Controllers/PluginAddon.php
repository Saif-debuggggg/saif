...
use WilokeProductFurniture\Share\TraitHandleAutoRenderSettingControls;
...
class PluginAddon extends Widget_Base
{
  ...
  protected function render()
  {
    try {
      ...
      Timber::$locations = WILOKE_WILOKEPRODUCTFURNITURE_VIEWS_PATH . 'src/Views';
      ...
      <p class="wil-element-warning wil-element-text-center">
        <?php esc_html_e('Something went error!', 'wil-product-funiture'); ?>
